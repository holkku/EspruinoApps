...
g.setFontAlign(0,0).setFont("6x8",2.5);
  g.drawString(date.as("0i:0m").str,45,30);

  g.setFontAlign(0,0).setFont("6x8",2.5);
  g.drawString(date.as("a").str.toUpperCase(),148,30);
  
  g.setFontAlign(0,0).setFont("6x8",2.5);
  g.drawString(date.as("0D.0M.").str,50,165);

    g.setFontAlign(0,0).setFont("6x8",2.5);
  g.drawString(date.as("T").str.toUpperCase(),155,165);
